...
public class P2FB_FloorDetection : MonoBehaviour {

    private P2FirebrandController controller;
    ...
    private void Awake()
    {
        controller = gameObject.GetComponentInParent<P2FirebrandController>();
