...
public class P1_Samus_Attacks : CharAttacks 
{
    private samus_P1_CharController controller;
    ...
    private void Start()
    {
        controller = gameObject.GetComponent<samus_P1_CharController>();
    ...
    {
        Collider2D[] cols = Physics2D.OverlapBoxAll(stats.hitBoxes[16].bounds.center, stats.hitBoxes[16].bounds.extents, 0.0f, LayerMask.GetMask("Player2"));
    ...
    {
        Collider2D[] cols = Physics2D.OverlapBoxAll(stats.hitBoxes[17].bounds.center, stats.hitBoxes[17].bounds.extents, 0.0f, LayerMask.GetMask("Player2"));
        foreach (Collider2D c in cols)
        {
            if (c.gameObject.tag.Equals("Player2"))
            {
    ...
    {
        Collider2D[] cols = Physics2D.OverlapBoxAll(stats.hitBoxes[14].bounds.center, stats.hitBoxes[14].bounds.extents, 0.0f, LayerMask.GetMask("Player2"));
        foreach (Collider2D c in cols)
        {
            if (c.gameObject.tag.Equals("Player2"))
            {
    ...
    {
        Collider2D[] cols = Physics2D.OverlapBoxAll(stats.hitBoxes[19].bounds.center, stats.hitBoxes[19].bounds.extents, 0.0f, LayerMask.GetMask("Player2"));
        foreach (Collider2D c in cols)
        {
            if (c.gameObject.tag.Equals("Player2"))
            {
    ...
    public override void SideSmash()
    {
        ...
        {
            cols = Physics2D.OverlapBoxAll(stats.hitBoxes[4].bounds.center, stats.hitBoxes[4].bounds.extents, 0.0f, LayerMask.GetMask("Player2"));
        }
        else
        {
    ...
    public override void SideSpecial()
    {
        ...
        if ((controller.timeInAttack < 0.033) || (controller.timeInAttack >= 1))
        {
            cols = Physics2D.OverlapBoxAll(stats.hitBoxes[20].bounds.center, stats.hitBoxes[20].bounds.extents, 0.0f, LayerMask.GetMask("Player2"));
        }
        ...
        {
            cols = Physics2D.OverlapBoxAll(stats.hitBoxes[21].bounds.center, stats.hitBoxes[21].bounds.extents, 0.0f, LayerMask.GetMask("Player2"));
        }
    ...
    public override void Special()
    {
        ...
        // check if the charging is done if done, then check charge percentage, if over 50%  then shoot charged shot, if not, shoot uncharged. 
            ...
            if(amountCharged > .5 )
            {
                ...
                chargedShot.GetComponent<chargedShotController>().enemyTag = "Player2";
            ...
            else
            {
                ...
                unchargedShot.GetComponent<unchargedShotController>().enemyTag = "Player2";
    ...
    {
        Collider2D[] cols = Physics2D.OverlapBoxAll(stats.hitBoxes[18].bounds.center, stats.hitBoxes[18].bounds.extents, 0.0f, LayerMask.GetMask("Player2"));
        foreach (Collider2D c in cols)
        {
            if (c.gameObject.tag.Equals("Player2"))
            {
