...
public class AI_Mario_Attacks : CharAttacks {
    private AI_MarioController controller;
    ...
    private void Start()
    {
        controller = gameObject.GetComponent<AI_MarioController>();
    ...
    public override void BackAir()
    {
        ...
        if (controller.timeInAttack >= 0.4f)
        {
            ...
            marioExplode.GetComponent<marioExplode>().enemyTag = "Player1";
    ...
    {
        Collider2D[] cols = Physics2D.OverlapBoxAll(stats.hitBoxes[21].bounds.center, stats.hitBoxes[21].bounds.extents, 0.0f, LayerMask.GetMask("Player1"));
    ...
    public override void DownSmash()
    {
        ...
        {
            cols = Physics2D.OverlapBoxAll(stats.hitBoxes[19].bounds.center, stats.hitBoxes[19].bounds.extents, 0.0f, LayerMask.GetMask("Player1"));
        ...
        {
            cols = Physics2D.OverlapBoxAll(stats.hitBoxes[18].bounds.center, stats.hitBoxes[18].bounds.extents, 0.0f, LayerMask.GetMask("Player1"));
            processForwardSmash(cols);
        }
    ...
    public override void SideSpecial()
    {
        ...
        Collider2D[] cols = Physics2D.OverlapBoxAll(stats.hitBoxes[20].bounds.center, stats.hitBoxes[20].bounds.extents, 0.0f, LayerMask.GetMask("Player1"));
        ...
        foreach (Collider2D c in cols)
        {
            if (c.gameObject.tag.Equals("Player1"))
            {
                ...
                if (!enemyStats.isShielding && !enemyStats.isInvincible)
                {
                    ...
                    try
                    {
                        enemy.GetComponent<P1_CharController>().facingRight = !enemy.GetComponent<P1_CharController>().facingRight;
                    }
                    catch
                    {
                        try
                        {
                            enemy.GetComponent<samus_P1_CharController>().facingRight = !enemy.GetComponent<samus_P1_CharController>().facingRight;
                        }
                        catch
                        {
        ...
        string newEnemy = "Player1";
        foreach (Collider2D c in projCols)
        {
            controller.multiHit = false;
            controller.hit = true;
            //Debug.Log(c.gameObject.tag + " reflected by AI cape");
    ...
    public override void Special()
    {
        ...
        marioFireball.GetComponent<marioFireball>().enemyTag = "Player1";
    ...
    public override void UpSmash()
    {
        ...
        {
            cols = Physics2D.OverlapBoxAll(stats.hitBoxes[12].bounds.center, stats.hitBoxes[12].bounds.extents, 0.0f, LayerMask.GetMask("Player1"));
        }
        ...
        {
            cols = Physics2D.OverlapBoxAll(stats.hitBoxes[13].bounds.center, stats.hitBoxes[13].bounds.extents, 0.0f, LayerMask.GetMask("Player1"));
        }
        ...
        {
            cols = Physics2D.OverlapBoxAll(stats.hitBoxes[14].bounds.center, stats.hitBoxes[14].bounds.extents, 0.0f, LayerMask.GetMask("Player1"));
        }
        ...
        {
            cols = Physics2D.OverlapBoxAll(stats.hitBoxes[16].bounds.center, stats.hitBoxes[16].bounds.extents, 0.0f, LayerMask.GetMask("Player1"));
        }
        else
        {
            cols = Physics2D.OverlapBoxAll(stats.hitBoxes[17].bounds.center, stats.hitBoxes[17].bounds.extents, 0.0f, LayerMask.GetMask("Player1"));
        }
