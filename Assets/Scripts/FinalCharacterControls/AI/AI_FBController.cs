...
public class AI_FBController : MonoBehaviour {
    ...
    {
        if (Borders(c) && stats.charState != CharacterStats.state.stun && stats.charState != CharacterStats.state.limbo && !freeFall)
        {
            recovering = true;
            stats.charState = CharacterStats.state.lag;
